...
EvaWiki имеет официальную документацию, которая может быть полезна при работе:
- **Документация EvaWiki**: https://docs.evateam.ru/docs/docs/DOC-000123
- Содержит информацию о макросах, плагинах, таблицах, графиках, диаграммах
- Описывает работу с историей документа, комментариями, правами доступа

Обратите внимание: некоторые функции EvaWiki (например, автоматическое оглавление) могут отсутствовать или требовать ручной настройки.
